define('aviary', ['defer', 'jquery', 'l10n', 'z'], function(defer, $, l10n, z) {
    ...
    var featherEditor = new Aviary.Feather({
        ...
        onSave: function(imageID, newURL) {
            ...
            $(img).siblings('.processed-image').val(newURL);
    ...
    z.page.one('loaded', function() {
    ...
    }).on('blur', '.aviary input[type=url]', function(e) {
        ...
        var $img = $(this);
        launchEditor($img.attr('id'), $img.siblings('.processed-image'));

    }).on('blur change', '.aviary input[type=file]', function(e) {
